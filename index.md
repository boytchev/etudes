...
For free-walking on a sphere you can use pure Three.js vector arithmetics. No need to fight with quaternions, matrices, Euler angles and gimbal locks. Slide the mouse or your finger to see it in this [Live demo](threejs/see-ma-no-quaternions.html). 
